...
class Board:
    ...
    btile = pygame.image.load(os.path.join(IMAGE_DIR, 'black-tile.png'))
    wtile = pygame.image.load(os.path.join(IMAGE_DIR, 'white-tile.png'))
    ...
    def displayBoard(self):
        ...
        pygame.draw.rect(self.DISPLAYSURF, self.colors['Brown'], (95, 95, 410, 410), 10)

        self.drawTiles()


    def drawTiles(self):
        """ find the range of the tiles and bliting the image """
